	...
	<div id="container">
		...
		<div class="location_area member">
			<div class="box_inner">
				...
				<p class="location">Board <span class="path">/</span> 게시판 답글쓰기</p>
				<ul class="page_menu clear">
					<li><a href="javascript:;" class="on">게시판 답글쓰기</a></li>
				</ul>
			</div>
		</div>	
		<!-- //location_area -->
		...
		<div class="bodytext_area box_inner">
			<!-- appForm -->
			<form action="./BoardReWriteAction.bo?pageNum=${param.pageNum }" method="post" class="appForm">
				<input type="hidden" name="bno" value="${param.bno }"> <!-- DB에 저장될 데이터는 숨겨서 가져가는게 좋음  -->
				...
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
							...
							<div class="app_content">
							<input type="text" name="subject" class="w100p" id="pwd_lbl" value="[답글]"/>
							</div>
						</li>
						<li class="clear">
					...
					<p class="btn_line">
						<input type="submit" value="답글쓰기" class="btn_baseColor">
					</p>	
				</fieldset>
			</form>
			<!-- //appForm -->
