	...
	<div id="container">
		...
		<div class="location_area member">
			<div class="box_inner">
				...
				<p class="location">Board <span class="path">/</span> 게시판 글 수정하기</p>
				<ul class="page_menu clear">
					<li><a href="javascript:;" class="on">게시판 글 수정하기</a></li>
				</ul>
			</div>
		</div>	
		<!-- //location_area -->
		...
		<div class="bodytext_area box_inner">
			<!-- appForm -->
			<form action="./BoardUpdateProAction.bo?pageNum=${pageNum }" method="post" class="appForm"> <!-- 파라메터 DB사용 안하면 주소줄에 사용가능 -->
				<input type="hidden" name="bno" value="${oldDto.bno }"> <!-- DB사용하면 주소줄에 안보이게 -->
				...
				<fieldset>
					...
					<ul class="app_list">
						<li class="clear">
							...
							<input type="text" name="name" class="w100p" id="id_lbl" value="${oldDto.name }"/>
							</div>
						</li>
						<li class="clear">
						...
						<li class="clear">
							...
							<div class="app_content">
							<input type="text" name="subject" class="w100p" id="pwd_lbl" value="${oldDto.subject }"/>
							</div>
						</li>
						<li class="clear">
							<label for="content_lbl" class="tit_lbl">내용</label>
							<div class="app_content">
							<textarea name="content" id="content_lbl" class="w100p" >${oldDto.content }</textarea>
							</div>
						</li>
					</ul>
					<p class="btn_line">
 					<!-- <a href="javascript:;" class="btn_baseColor">글쓰기</a> -->
						<input type="submit" value="글 수정하기" class="btn_baseColor">
					</p>	
				</fieldset>
			</form>
			<!-- //appForm -->
