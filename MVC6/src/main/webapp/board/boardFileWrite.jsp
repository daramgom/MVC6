	...
	<div id="container">
		...
		<div class="location_area member">
			<div class="box_inner">
				...
				<p class="location">Board <span class="path">/</span> 게시판 파일 글쓰기</p>
				<ul class="page_menu clear">
					<li><a href="javascript:;" class="on">게시판 파일 글쓰기</a></li>
				</ul>
			</div>
		</div>	
		<!-- //location_area -->
		...
		<div class="bodytext_area box_inner">
			<!-- appForm -->
			<form action="./BoardFileWriteAction.bo" method="post" enctype="multipart/form-data" class="appForm">
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
							<label for="content_lbl" class="tit_lbl">첨부파일</label>
							<div class="app_content">
