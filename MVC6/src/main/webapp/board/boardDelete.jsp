	...
	<div id="container">
		...
		<div class="location_area member">
			<div class="box_inner">
				...
				<p class="location">Board <span class="path">/</span> 게시판 글삭제</p>
				<ul class="page_menu clear">
					<li><a href="javascript:;" class="on">게시판 글삭제</a></li>
				</ul>
			</div>
		</div>	
		<!-- //location_area -->
		...
		<div class="bodytext_area box_inner">
			<!-- appForm -->
			<form action="./BoardDeleteAction.bo?pageNum=${param.pageNum }" method="post" class="appForm">
				<input type="hidden" name="bno" value="${param.bno }">
				<fieldset>
					<legend>게시글 삭제 양식</legend>
					...
					<p class="btn_line">
 					<!-- <a href="javascript:;" class="btn_baseColor">글쓰기</a> -->
						<input type="submit" value="글삭제" class="btn_baseColor">
					</p>	
				</fieldset>
			</form>
			<!-- //appForm -->
